...
<div class="main">
    ...
    <section class="hero-section ptb-100 " style="background: linear-gradient(
75deg
,#258a36 10%, #059fe8) !important;
} ">
        <div class="container">
                    ...
                    <div class="card single-promo-card single-promo-hover text-center shadow-sm">
                        <div class="card-body py-5">
                            ...
                            <div><h5 class="mb-0">Mail Us</h5>
                                <p class="text-muted mb-0">theassignmentwriting12@gmail.com</p></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
            ...
            <div class="row justify-content-around">
                ...
                <div class="col-md-5">
                    <div class="contact-us-content">
                        ...
                        <br>
                        <span>Phone: 0015167383453 US whatsapp number</span> <br>
                        <span>Email: <a href="mailto:email@yourdomain.com" class="link-color">theassignmentwriting12@gmail.com/a></span>
