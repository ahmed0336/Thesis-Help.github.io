...
<div class="main">
    ...
    <section class="hero-section ptb-100 gradient-overlay" style="background: linear-gradient(
75deg
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-sm-12 col-lg-5">
                    <div class="team-single-img">
                        <img src="slider img /Grace Ling .jpg" width="300" alt="member" class="img-fluid rounded shadow-sm">
                    </div>
                </div>
